package body Date.Test.Byte_Checker_i16 is

   procedure Initialize (T : in out Test) is
   begin
      Set_Name (T, "Date.Test.Byte_Checker_i16");
   ...
   function Write_Read (Value : i16) return i16 is
   ...
   procedure First is
      Value : i16 := i16'First;
   begin
      Ahven.Assert (Value = Write_Read (Value), "Read i16 is not " & i16'Image (Value));
   end First;
