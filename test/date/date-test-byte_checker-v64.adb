package body Date.Test.Byte_Checker.v64 is

   procedure Initialize (T : in out Test) is
   begin
      Set_Name (T, "Date.Test.Byte_Checker.v64");
   ...
   procedure First is
      Value : Date.v64 := Date.v64'First;
   begin
      Ahven.Assert (Value = Write_Read (Value), "Read v64 is not " & Date.v64'Image (Value));
   end First;
