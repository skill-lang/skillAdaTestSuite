package body Date.Test.Byte_Checker_i8 is

   procedure Initialize (T : in out Test) is
   begin
      Set_Name (T, "Date.Test.Byte_Checker_i8");
   ...
   function Write_Read (Value : i8) return i8 is
   ...
   procedure First is
      Value : i8 := i8'First;
   begin
      Ahven.Assert (Value = Write_Read (Value), "Read i8 is not " & i8'Image (Value));
   end First;
